...
### 🎬 AI Algorithm Video Generator (New!)
CodeMaster now includes an advanced AI-powered Algorithm Video Generator that transforms coding problems into animated educational videos automatically using Gemini AI.
- **Generate AI Video Explanations**: With a click of a button, Gemini AI analyzes the problem statement and algorithm.
- **Timeline-Driven Animation**: Features 2D motion graphics, highlighted elements, and step-by-step code execution visualization.
- **Dynamic Elements**: Includes variable changes, array/graph traversal animations, swapping effects, and real-world analogy narration.
- **Voice-over & Captions**: Educational commentary generated by AI acts as an interactive narrator during the animation.
- **Interactive UI**: Dark-themed educational player with playback controls, pause/resume functionality, and speed control.
