        ...
        <div className="min-h-screen bg-[#0B0F19] text-gray-200 font-sans selection:bg-blue-500/30 relative overflow-hidden">
            ...
            <div className="container mx-auto px-4 pt-24 pb-12 relative z-10 max-w-5xl">
                <div className="text-center mb-10">
                    <h1 className="text-3xl md:text-4xl font-bold text-gray-100 mb-2">Create New Problem</h1>
                    <p className="text-gray-400">Design a new challenge for the community.</p>
                </div>
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="form-control md:col-span-2">
                                <label className="label mb-2 block">
                                    <span className="text-sm font-medium text-gray-400">Problem Title</span>
                                </label>
                                <input
                                    {...register('title')}
                    ...
                    <div className="fixed bottom-6 right-6 z-40">
                        <button
                            ...
                            className="flex items-center gap-2 px-8 py-4 bg-blue-600 hover:bg-blue-500 text-white rounded-full shadow-2xl shadow-blue-600/30 transition-all transform hover:scale-105 active:scale-95 font-bold disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                            {isSubmitting ? (
                            ...
                            <span>{isSubmitting ? 'Creating...' : 'Create Problem'}</span>
                        </button>
                    </div>
                </form>
            </div>
